...
| Testing | Chưa bắt đầu | 40% |
**Tổng tiến độ: 65%**
---
## 3. Kế hoạch tuần tới
| Thành viên | Công việc dự kiến |
|------------|-------------------|
| Phan Khánh Vy | Theo dõi tiến độ, kiểm tra sự đồng bộ giữa Backend - Frontend, review API và hỗ trợ xử lý lỗi tích hợp |
| Trịnh Chí Đông | Hoàn thiện test cases, thực hiện test API và UI, cập nhật kết quả test (pass/fail) |
| Nguyễn Cao Hữu | Hoàn thiện CRUD API còn thiếu (invoice, payment), tối ưu API, fix bug và cập nhật docs/api-docs.md |
| Nguyễn Thụy Anh Thư | Hoàn thiện tích hợp API (room, tenant, contract), hiển thị dữ liệu đầy đủ, xử lý các case lỗi và hoàn thiện UI |
